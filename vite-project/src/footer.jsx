...
const Footer = () => {
    return (
        <>
            <footer className="rounded-lg w-[1200px] sm:-mx-[328px] md:mx-36 sm:flex-auto mx-40 my-3 bg-black shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8  dark:bg-gray-800 antialiased">
